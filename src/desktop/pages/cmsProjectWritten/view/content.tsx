...
const Content: React.FC<IContentViewProps> = props => {
  ...
  const toPrintPage = useCallback(() => {
    ...
    const params = `?fdEntityName=${'com.landray.cms.out.project.core.entity.CmsProjectWritten'}&fdType=${'normal'}&fdEntityCode=${'cms-project'}`
    history.goto(`/cmsProjectWritten/print/${data.fdId}${params}`)
  }, [history])
