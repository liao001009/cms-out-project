...
const Content: React.FC<IContentViewProps> = props => {
  ...
  const toPrintPage = useCallback(() => {
    ...
    const params = `?fdEntityName=${'com.landray.cms.out.project.core.entity.CmsProjectInterview'}&fdType=${'normal'}&fdEntityCode=${'cms-project'}`
    history.goto(`/cmsProjectInterview/print/${data.fdId}${params}`)
  }, [history])
