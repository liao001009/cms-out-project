...
import AddComponent from '@/mobile/pages/cmsProjectDemandTemplate/baseList'
import './index.scss'
...
const Content: React.FC<IContentViewProps> = (props) => {
  ...
  //新建
  const { $add: $add, $addClose: $addClose, $addVisible: $addVisible } = useAdd('/cmsProjectDemand/add/!{selectedRow}')
