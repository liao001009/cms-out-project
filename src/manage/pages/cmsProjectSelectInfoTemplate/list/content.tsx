...
import api from '@/api/cmsProjectSelectInfoTemplate'
import AddComponent from '@/manage/pages/cmsProjectSelectInfoTemplate/baseEdit'
...
const Content: React.FC<IContentViewProps> = (props) => {
  ...
  const handleEdit = useCallback((event, record) => {
    event.stopPropagation()
    history.goto(`/cmsProjectSelectInfoTemplate/edit/${record.fdId}`)
  }, [])
  //删除
