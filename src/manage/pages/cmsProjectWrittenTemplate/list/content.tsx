...
import api from '@/api/cmsProjectWrittenTemplate'
import AddComponent from '@/manage/pages/cmsProjectWrittenTemplate/baseEdit'
...
const Content: React.FC<IContentViewProps> = (props) => {
  ...
  const handleEdit = useCallback((event, record) => {
    event.stopPropagation()
    history.goto(`/cmsProjectWrittenTemplate/edit/${record.fdId}`)
  }, [])
  //删除
