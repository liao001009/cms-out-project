...
import api from '@/api/cmsStaffReviewTemplate'
import AddComponent from '@/manage/pages/cmsStaffReviewTemplate/baseEdit'
...
const Content: React.FC<IContentViewProps> = (props) => {
  ...
  const handleEdit = useCallback((event, record) => {
    event.stopPropagation()
    history.goto(`/cmsStaffReviewTemplate/edit/${record.fdId}`)
  }, [])
  //删除
